...
public class Input_Inventory : MonoBehaviour
{
    ...
    public Output_inventory Output;
    ...
    void Update()
    {
        if(itemSlots[1].ItemInSlot&& itemSlots[4].ItemInSlot)
        {
            if(itemSlots[1].ItemInSlot.ItemID == 3 && itemSlots[4].ItemInSlot.ItemID == 3)
            {
                Output.itemSlots[0].SetContents(masterItemTable.GetItem(2), 1);
                itemSlots[1].SetContents(null, 0);
                itemSlots[4].SetContents(null, 0); 
            }
        }

        if(itemSlots[0].ItemInSlot && itemSlots[4].ItemInSlot && itemSlots[8].ItemInSlot)
        {
            if(itemSlots[0].ItemInSlot.ItemID == 16 && 
               itemSlots[8].ItemInSlot.ItemID == 16 &&
               itemSlots[4].ItemInSlot.ItemID == 17)
            {
                Output.itemSlots[0].SetContents(masterItemTable.GetItem(18), 1);
                itemSlots[0].SetContents(null, 0);
                itemSlots[4].SetContents(null, 0);
                itemSlots[8].SetContents(null, 0);
            }
        }

        if (itemSlots[4].ItemInSlot && itemSlots[6].ItemInSlot && itemSlots[7].ItemInSlot && itemSlots[8].ItemInSlot)
        {
            if (itemSlots[4].ItemInSlot.ItemID == 18 &&
               itemSlots[6].ItemInSlot.ItemID == 16 &&
               itemSlots[7].ItemInSlot.ItemID == 16 &&
               itemSlots[8].ItemInSlot.ItemID == 16)
            {
                Output.itemSlots[0].SetContents(masterItemTable.GetItem(19), 1);
                itemSlots[4].SetContents(null, 0);
                itemSlots[6].SetContents(null, 0);
                itemSlots[7].SetContents(null, 0);
                itemSlots[8].SetContents(null, 0);
            }
        }

        if (itemSlots[4].ItemInSlot && itemSlots[3].ItemInSlot && itemSlots[5].ItemInSlot)
        {
            if (itemSlots[4].ItemInSlot.ItemID == 19 &&
               itemSlots[3].ItemInSlot.ItemID == 21 &&
               itemSlots[5].ItemInSlot.ItemID == 21)
            {
                Output.itemSlots[0].SetContents(masterItemTable.GetItem(20), 1);
                itemSlots[4].SetContents(null, 0);
                itemSlots[3].SetContents(null, 0);
                itemSlots[5].SetContents(null, 0);
            }
        }
    }
